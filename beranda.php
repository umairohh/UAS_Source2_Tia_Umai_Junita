    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di KITA TRAVEL</strong>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th>Nama</th><th>Alamat</th><th>Nama Wisata</th><th>Jadwal Keberangkatan</th><th>Jumlah Pengunjung</th><th>Harga Tiket</th>
                            </tr>
                        </thead>
                        <tbody>
